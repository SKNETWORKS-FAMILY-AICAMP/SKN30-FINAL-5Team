...
CONDITIONALS: dict[str, dict[str, str]] = {
    "NEX-000002": rec(
        ...
        "풀오버 직접 항목은 없으므로 일반 저항운동 02054를 상위 유형의 참고값으로만 제안합니다. 운동별 부하·휴식이 확인되기 전에는 승인하지 않습니다.",
    ),
    "NEX-000003": rec(
        "바벨 풀오버, 8–15회, 세트 간 60–90초, 중량은 통제 가능한 보통 부하, 느린-중간 템포",
        "MODERATE",
        ...
        "Resistance (weight) training, multiple exercises, 8-15 reps at varied resistance",
        "PROVISIONAL_ESTIMATE",
        "와이드 그립·디클라인 변형의 직접 항목은 없으므로 02054를 참고값으로만 제안합니다. 자세·부하 조건 확인이 필요합니다.",
    ),
    "NEX-000005": rec(
        "바벨 풀오버, 8–15회, 세트 간 60–90초, 중량은 통제 가능한 보통 부하, 느린-중간 템포",
        "MODERATE",
        ...
        "Resistance (weight) training, multiple exercises, 8-15 reps at varied resistance",
        "PROVISIONAL_ESTIMATE",
        "풀오버 직접 항목은 없으므로 02054를 상위 유형의 참고값으로만 제안합니다. 실제 부하와 휴식 확인이 필요합니다.",
    ),
    "NEX-000065": rec(
        ...
        "PROVISIONAL_ESTIMATE",
        "역방향 레그 컬 직접 항목은 없으므로 자체 체중 저항운동 일반값을 참고합니다. 벤치 보조 수준과 반복 속도 확인이 필요합니다.",
    ),
    "NEX-000076": rec(
        "자기 선택 조깅 속도(보통 성인의 지속 가능한 조깅), 평지, 중단 없는 지속 수행",
        "VIGOROUS",
        "7.5",
        "12028 / 6.5 MET / 4.0–4.2 mph | 12029 / 7.8 MET / 4.3–4.8 mph | 12030 / 8.5 MET / 5.0–5.2 mph | 12045 / 9.0 MET / 5.5–5.8 mph | 12050 / 9.3 MET / 6.0–6.3 mph",
        "12020",
        "Jogging, general, self-selected pace",
        "CONDITIONAL_MATCH",
        "운동명만으로 속도를 확정할 수 없으므로 자기 선택 조깅을 기본 조건으로 둔 조건부 제안입니다. 실제 속도에 따라 선택지를 바꿔야 합니다.",
    ),
    "NEX-000081": rec(
        ...
        "Body weight resistance exercises, general",
        "PROVISIONAL_ESTIMATE",
        "직접 대응 항목이 없어 자체 체중 저항운동 일반값을 참고합니다. 바닥 변형의 난이도와 반복 속도 확인이 필요합니다.",
    ),
    "NEX-000082": rec(
        ...
        "Body weight resistance exercises, general",
        "PROVISIONAL_ESTIMATE",
        "직접 대응 항목이 없어 자체 체중 저항운동 일반값을 참고합니다. 수행 보조와 반복 속도 확인이 필요합니다.",
    ),
    "NEX-000087": rec(
        ...
        "Body weight resistance exercises, general",
        "PROVISIONAL_ESTIMATE",
        "직접 대응 항목이 없어 자체 체중 저항운동 일반값을 참고합니다. 균형 보조 여부와 반복 속도 확인이 필요합니다.",
    ),
    "NEX-000112": rec(
        ...
        "PROVISIONAL_ESTIMATE",
        "하부 등 컬 직접 항목은 없으므로 유사한 저강도 코어·복부 운동을 참고합니다. 동작 범위와 속도 확인이 필요합니다.",
    ),
    "NEX-000113": rec(
        ...
        "Body weight resistance exercises, general",
        "PROVISIONAL_ESTIMATE",
        "사용자 확인에 따라 저항성 운동으로 분류합니다. 직접 대응 항목은 없으므로 자체 체중 저항운동 일반값을 참고값으로만 제안하며 실제 동작·유지시간·반복수를 확인해야 합니다.",
    ),
    "NEX-000129": rec(
        ...
        "Yoga, general",
        "CONDITIONAL_MATCH",
        "자세 단독 수행은 전체 요가 세션과 다르므로 일반 요가값을 조건부로만 제안합니다. 정적 스트레칭으로 확인되면 02101을 검토합니다.",
    ),
    "NEX-000143": rec(
        "고정식 자전거, 60 W, 일정 케이던스, 중간 강도, 지속 수행",
        "MODERATE",
        "5.0",
        "01210 / 3.5 MET / 25–30 W | 01214 / 4.0 MET / 50 W | 01218 / 5.8 MET / 70–80 W | 01220 / 6.0 MET / 90–100 W | 01224 / 6.8 MET / 101–125 W | 01228 / 8.0 MET / 126–150 W | 01232 / 10.3 MET / 151–199 W",
        "01216",
        "Bicycling, stationary, 60 watts, light to moderate effort",
        "CONDITIONAL_MATCH",
        "사용자 확인에 따라 운동명을 stationary bike로 정규화합니다. 출력·저항에 따라 MET가 달라지므로 60 W를 일반적인 중간 강도 기본조건으로 두고 조건별 선택지를 함께 제시합니다.",
    ),
    "NEX-000152": rec(
        ...
        "Stretching, mild",
        "CONDITIONAL_MATCH",
        "척추 트위스트가 스트레칭으로 수행된다는 조건에서 mild stretching과 대응합니다. 동적·고반복 회전이면 재검토해야 합니다.",
    ),
    "NEX-000156": rec(
        ...
        "Body weight resistance exercises, general",
        "PROVISIONAL_ESTIMATE",
        "직접 대응 항목이 없어 자체 체중 저항운동 일반값을 참고합니다. 케이블 보조량과 반복 속도 확인이 필요합니다.",
    ),
    "NEX-000160": rec(
        ...
        "Resistance (weight) training, multiple exercises, 8-15 reps at varied resistance",
        "PROVISIONAL_ESTIMATE",
        "밴드 레그 익스텐션 직접 항목이 없어 8–15회 일반 저항운동을 참고합니다. 밴드 장력과 휴식 조건 확인이 필요합니다.",
    ),
    "NEX-000161": rec(
        ...
        "Resistance (weight) training, multiple exercises, 8-15 reps at varied resistance",
        "PROVISIONAL_ESTIMATE",
        "EZ바 풀오버 직접 항목은 없으므로 02054를 상위 유형의 참고값으로만 제안합니다. 실제 부하와 휴식 확인이 필요합니다.",
    ),
    "NEX-000169": rec(
        ...
        "Jogging, general, self-selected pace",
        "CONDITIONAL_MATCH",
        "short stride만으로 속도와 에너지 비용을 결정할 수 없어 자기 선택 조깅을 조건부 기본값으로 제안합니다. 실제 속도에 따라 선택지를 적용합니다.",
    ),
    "NEX-000170": rec(
        ...
        "PROVISIONAL_ESTIMATE",
        "경사 트레드밀 직접 항목 대신 경사 걷기 상위 유형을 사용한 조건부 참고값입니다. 실제 속도·경사도에 따라 선택지를 바꿔야 합니다.",
    ),
    "NEX-000172": rec(
        ...
        "CONDITIONAL_MATCH",
        "스텝박스 높이와 속도가 없어 4인치·중간 속도를 기본 조건으로 제안합니다. 높이와 속도 확인 후 선택지를 적용해야 합니다.",
    ),
    "NEX-000173": rec(
        "의자 보조 없음, 이동 없음, 한 발 정적 유지. 한 발 유지시간·반복 횟수·반복 간 휴식에 따라 총 수행시간과 부담을 조절",
        "LIGHT",
        "2.3",
        ...
        "Yoga, Hatha",
        "USER_APPROVED_PROXY",
        "직접 대응하는 한 발 정적 균형 항목은 없으므로 02150 Hatha yoga를 보수적 프록시로 사용합니다. 이 값은 사용자 승인으로 확정하지만 운동 자체의 직접 측정값으로 해석하지 않습니다.",
    ),
    "NEX-000180": rec(
        ...
        "Body weight resistance exercises, general",
        "PROVISIONAL_ESTIMATE",
        "의자 보조 레그 컬 직접 항목이 없어 자체 체중 저항운동 일반값을 참고합니다. 보조 정도와 반복 속도 확인이 필요합니다.",
    ),
    "NEX-000191": rec(
        ...
        "Resistance (weight) training, multiple exercises, 8-15 reps at varied resistance",
        "PROVISIONAL_ESTIMATE",
        "밴드 레그 컬 직접 항목이 없어 8–15회 일반 저항운동을 참고합니다. 밴드 장력·휴식·반복 속도 확인이 필요합니다.",
    ),
}
...
def main() -> None:
    ...
    unresolved = [
        ...
        if row.get("recommended_intensity") == "REVIEW_REQUIRED" or not row.get("recommended_met", "").strip()
    ]
    ...
    for source in sorted(unresolved, key=lambda row: row["exercise_id"]):
        ...
        proposal["exercise_name"] = "stationary bike" if source["exercise_id"] == "NEX-000143" else source["exercise_name"]
