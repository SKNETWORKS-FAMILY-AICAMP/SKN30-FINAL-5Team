...
TEMPLATES = [
    ...
    },
    {
        ...
        "fitt_basis": (
            "전문가 검수 완료. 벽을 미는 등척성 광배근 활성화 운동에 "
            "5–10초 유지시간 범위를 적용한다."
        ),
    },
    {
        ...
        "default_intensity": "MODERATE",
        "fitt_basis": (
            "전문가 검수 완료. 케틀벨 스윙은 일반 HINGE와 분리한 ballistic/power 동작이며, "
            "빠른 concentric 수행과 보수적 반복 범위를 적용한다. "
            "개별 부하·속도·기술은 Agent가 결정한다."
        ),
    },
    {
        "experience_level_code": "BEGINNER",
    ...
    },
    {
        ...
        "default_sets": "",
        "default_reps": "",
        "default_work_seconds": "600",
        "min_work_seconds": "600",
        "max_work_seconds": "2400",
        "default_rest_seconds": "",
        "default_transition_seconds": "",
        "default_intensity": "MODERATE",
        "fitt_basis": "연속 유산소는 기본 10분, 처방 범위 10~40분으로 설정한다.",
    },
    {
        "experience_level_code": "BEGINNER",
        "fitt_template_id": "FITT-CARDIO-INTERVAL-V1",
        "template_name": "Cardio interval",
        "movement_pattern": "CARDIO",
        "training_category": "CARDIO",
        "prescription_unit": "SECONDS",
        "default_sets": "",
        ...
        "default_transition_seconds": "",
        "default_intensity": "LIGHT_MODERATE",
        "fitt_basis": "인터벌 유산소는 30~60초 work/rest 범위로 설정한다.",
    },
]
