...
def catalog_row(identity: str, *, name_en: str, equipment: str, location: str = "") -> dict[str, str]:
    return {
...
def test_incline_and_decline_variants_are_gym_only() -> None:
    rows = [
        catalog_row("0001", name_en="incline scapula push up", equipment="BODYWEIGHT", location="GYM|HOME"),
        catalog_row("0002", name_en="bodyweight incline side plank", equipment="BODYWEIGHT", location="GYM|HOME"),
        catalog_row("0003", name_en="rear decline bridge", equipment="BODYWEIGHT", location="GYM|HOME"),
        catalog_row("1259", name_en="behind head chest stretch", equipment="BODYWEIGHT"),
    ]
...
def test_translates_reviewed_foam_roller_names_from_korean() -> None:
    rows = [
        catalog_row("1259", name_en="behind head chest stretch", equipment="BODYWEIGHT"),
        catalog_row("2203", name_en="roller seated shoulder flexor depresor retractor", equipment="FOAM_ROLLER"),
        catalog_row("2206", name_en="roller reverse crunch", equipment="FOAM_ROLLER"),
        catalog_row("2209", name_en="roller seated single leg shoulder flexor depresor retractor", equipment="FOAM_ROLLER"),
    ]
