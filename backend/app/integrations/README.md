...
`calendar_provider.py`는 ADR-0010 승인 전 local/CI에서 사용하는 unavailable null object입니다.
Google Calendar 원시 payload나 token을 domain에 전달하지 않으며 실제 HTTP adapter는 9C-2 범위입니다.
