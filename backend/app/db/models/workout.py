...
class WorkoutSafetyEvent(Base):
    ...
    symptom_code: Mapped[str | None] = mapped_column(String(64), nullable=True)
    body_area_code: Mapped[str | None] = mapped_column(
        String(64), ForeignKey("body_areas.code", ondelete="RESTRICT"), nullable=True
    )
    nrs_score: Mapped[int | None] = mapped_column(Integer, nullable=True)
