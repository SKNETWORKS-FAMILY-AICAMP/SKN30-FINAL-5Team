...
PERSISTENCE_BUNDLE_SCHEMA_VERSION: Final[Literal["v3-decision-persistence-bundle-v4"]] = (
    "v3-decision-persistence-bundle-v4"
)
...
class V3DecisionPersistenceBundle(_FrozenModel):
    schema_version: Literal["v3-decision-persistence-bundle-v4"] = PERSISTENCE_BUNDLE_SCHEMA_VERSION
