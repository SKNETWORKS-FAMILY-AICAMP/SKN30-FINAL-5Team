...
| F011 | 4.1, 4.10, 4.11, 5.2 | MVP_SCOPE·API_CONTRACT·DATA_MODEL·DOMAIN_RULES·TEST_STRATEGY·ADR-0006·ADR-0010·TASK-BACKEND-007 | AC-F011-1-1~1-8 | TC-F011-1-1~1-8·backend/tests/unit/test_external_context.py·backend/tests/scenarios/test_external_context_golden.py | 정책 코어 구현·ADR 승인 대기 |
...
- F011 Google Calendar 실제 credential·secret manager 경로와 ADR-0010 승인 뒤 9C-2 adapter 검증
