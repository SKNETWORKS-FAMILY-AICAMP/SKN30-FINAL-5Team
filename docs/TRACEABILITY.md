...
| F002 | 2.4, 2.7, 3.2, 3.3, 3.5, 4.5, 4.7, 5.2, 5.3 | MVP_SCOPE·PROJECT_BRIEF·ARCHITECTURE·DOMAIN_RULES·API_CONTRACT·DATA_MODEL·TECHNICAL_PLAN·IMPLEMENTATION_PLAN·TEST_STRATEGY·ADR-0007 | AC-F002-1-1~1-60 | TC-F002-1-1~1-60 | `PARTIAL` |
...
| F029 | 3.5, 4.6, 5.2 | MVP_SCOPE·API_CONTRACT·DATA_MODEL·TEST_STRATEGY·ADR-0007 | AC-F029-1-1~1-15 | TC-F029-1-1~1-15 | `IMPLEMENTED` |
